...
from modelhub import dense_effect
...
model_id = f"dense_ep{args.EPOCHS}_nlv{args.nLV}_bs{args.bs}_lr{args.lr}_train_size{args.train_size}_seed{args.seed}"
print(model_id)
#%%
...
model = dense_effect(adata, n_latent = args.nLV)
