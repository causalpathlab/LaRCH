...
from larch.util.modelhub import TreeBayesian
...
def main():
    ...
    model_id = f"tree_bayesian_{args.data_id}_ep{args.EPOCHS}_treeD{args.tree_depth}_bs{args.bs}_lr{args.lr}_train_size{args.train_size}_pip{args.pip0}_kl{args.kl_weight}_klbeta{args.kl_weight_beta}_seed{args.seed}"
    print(model_id)
