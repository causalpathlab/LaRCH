...
from nn.util import _CONSTANTS, DataSplitter, TrainRunner, BaseModelClass
from nn.TrainingPlan import TrainingPlan
from nn.DeltaTopic_module import ETM_module, BETM_module
...
class dense_effect(BaseModelClass):
    """
    ETM
    ...
    ----------
    adata_seq
        Spliced and unspliced count AnnData object that has been registered via :func:`setup_anndata`
        and contains data.
    n_latent
    ...
    **model_kwargs
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        super(dense_effect, self).__init__()
    ...
    def get_parameters(
        ...
        np.savetxt(os.path.join(
                save_dir,"model_parameters", "beta.txt"
            ), decoder.rho.cpu().numpy())                
