...
from simdata_util import sim_data_NB
...
dir = os.path.join("data", f"simdataNB_seed{seed}_N{N}_G{G}_S{S}_treeD{D_tree}_0")

if not os.path.exists(dir):

    torch.manual_seed(seed)
    X, A, anchor_gene_mat, theta, pi, beta, node_effect, rho, sequence_depth, sample_name, gene_name, node_name, topic_name = sim_data_NB(N, G, S, D_tree)
